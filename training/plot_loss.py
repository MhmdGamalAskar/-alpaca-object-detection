...
plt.plot(range(20*N-1,20*len(train_loss),20),train_loss_avg , label='train loss' , color = 'blue')
plt.plot(range(20 * N - 1, 20 * len(train_loss), 20), val_loss_avg, label='val loss' , color = 'darkorange')
plt.legend()
plt.grid()
